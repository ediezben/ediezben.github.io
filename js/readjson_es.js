...
function constructTable(selector) {
      ...
      function Headers(list, selector) {
          var columns = [];
          var html_head = '<thead style="color:black;"><tr><th>Selecciona un tipo de proceso:</th></tr><thead>';
          ...
          for (var i = 0; i < keys.length; i++) {
            ...
            var html_head_1 = '<thead style="color:black;"><tr><th>Selecciona un proceso:</th></tr><thead>';
            html_t += html_head_1;
            for (var k = 0; k < keys_step_1.length; k++) {
              ...
              html_t+='<table class="table table-striped">';
              var html_head_2 = '<thead style="color:black;"><tr><th>Selecciona un "workflow":</th></tr><thead>';
              html_t += html_head_2;
              for (var m = 0; m < keys_step_2.length; m++) {
                ...
                html_t+='<table class="table table-striped">';
                html_t+='<thead><tr style="color:black;background-color:rgba(179,198,73,0.5)"><th>Tarea</th><th>Descripccion del AI TOOL</th><th>KPI de Eficacia</th><th>Valor del KPI de eficacia</th><th>Tasa de mejora de eficacia (%)</th><th>KPI de eficiencia</th><th>Valor del KPI de eficiencia</th><th>Tasa de mejora de eficiencia (%)</th><th>Include on report</></thead>';
                // alert(obj_step_3)
